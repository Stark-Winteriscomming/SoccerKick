					...
					<div align="center">
						...
						<div style="position: absolute;">
							<div style="position: relative; top: 120px; left: 85px;">
								<input type="image" src="../../../resources/img/button.png"
									border="0" style="width: 30%; height: 30%;"
									onClick="javascript:window.open('/myPage/ss','popup','scrollbars=no, resizable=no, width=800,height=600')">
							</div>
						</div>
						<div style="position: absolute;">
				...
				<div class="alert alert-info" style="width: 800px; float: left;">
					<div align="center">
							...
							<form name="selectForm" action="" method="get">
								...
								<tr>
									<td><input type="checkbox" name="scheck" id="scheck"
										value=""></td>
									<td><img
										src="http://sstatic.naver.net/people/38/201312311422378171.jpg" /></td>
									<td>2</td>
									<td>손흥민</td>
									<td>25</td>
									<td>서울</td>
								...
								<tr>
									<td><input type="checkbox" name="scheck" id="scheck"
										value=""></td>
									<td><img
										src="http://sstatic.naver.net/people/12/201106291743205631.bmp" /></td>
									<td>3</td>
									<td>박지성</td>
									<td>35</td>
									<td>서울</td>
								...
								<tr>
									<td><input type="checkbox" name="scheck" id="scheck"
										value=""></td>
									<td><img
										src="http://sstatic.naver.net/people/17/201403271921402431.jpg" /></td>
									<td>4</td>
									<td>차두리</td>
									<td>36</td>
									<td>독일</td>
								...
								<tr>
									<td><input type="checkbox" name="scheck" id="scheck"
										value=""></td>
									<td><img
										src="http://sstatic.naver.net/people/3/201607071816066361.jpg" /></td>
									<td>5</td>
									<td>메시</td>
									<td>29</td>
									<td>아르헨티나</td>
						...
						<button class="cselect" style="width: 280px; height: 80px;"
							align="center">선택 취소</button>
						<button class="cselect" style="width: 280px; height: 80px;"
							align="center">선택 완료</button>
...
>>>>>>> 2cd2406c62c24b693ecb6d1a758a09882de2df60
</section>
