			...
			<div class="container">
					...
					<div class="establish">
						<div class="parsleyGroupValidate">
							<table>
								...
								<tbody>
									<tr>
										<td><input type="text" class="people" />명</td>
										<td><input type="text" class="money" />원</td>
										<td><select>
												<option>선착순</option>
												<option>개설자 선정</option>
										</select></td>
										<td>자신포함 <input type="text" class="people" />명
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="aplication_phone">
					...
					<div class="edit">
						<div class="contact">
							<div class="phone">
								<span>전화번호 입력</span> <select class="ownerphone_head">
							...
							<div class="email">
								<span>이메일 입력</span> <input type="text" />@ <input type="text" />
							</div>
						</div>
					</div>
				</div>
				<div class="btn_group">
					<input type="submit" class="btn_open" value="개설하기" /> <input
