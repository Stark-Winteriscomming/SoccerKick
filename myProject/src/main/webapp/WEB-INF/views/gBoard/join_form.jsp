...
<head>
    ...
    <link href="/resources/chang/css/bootstrap.min.css" rel="stylesheet">
    <link href="/resources/chang/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="/resources/chang/css/agency.css" rel="stylesheet">
    <link rel="stylesheet" href="/resources/chang/css/joinform.css" />
    <link rel="stylesheet" href="/resources/chang/css/font-awesome.min.css" media="screen" title="no title">
    <link rel="stylesheet" href="/resources/chang/css/style.css" media="screen" title="no title" >
</head>
...
<body id="page-top" class="index">
    ...
    <!-- jQuery -->
    <script src="/resources/chang/js/jQuery-2.1.4.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/resources/chang/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js" integrity="sha384-mE6eXfrb8jxl0rzJDBRanYqgBxtJ6Unn4/1F7q4xRRyIw7Vdg9jP4ycT7x1iVsgb" crossorigin="anonymous"></script>

    <!-- Contact Form JavaScript -->
    <script src="/resources/chang/js/jqBootstrapValidation.js"></script>
    <script src="/resources/chang/js/contact_me.js"></script>

    <!-- Theme JavaScript -->
    <script src="/resources/chang/js/agency.min.js"></script>
