			...
			<div style="float: right; width: 50%;">
				<div class="checks" style="border: 1px solid yellow;">
					<div style="width:50%; margin:0 auto;border:1px solid gray;">
						<img src="http://sstatic.naver.net/people/91/201405301047405271.jpg" style="display:block; margin:0 auto;"/>
						<div style="padding:20px;">
							이름 <label id="name"> changho232 </label><br>
							지역<label id="region"> 서울  </label><br>
							나이<label id="age"> 23  </label><br>
							히스토리<label id="history"> 대학교 졸업  </label>
						</div>
					</div>
				</div>
			</div>
